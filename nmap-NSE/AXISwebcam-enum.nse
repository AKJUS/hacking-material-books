...
action = function(host, port)
    ...
    if ( check_uri.status == 401 ) then   --> uri auth login found
        ...
        print("|  Risk factor: Medium CVSSv2: 5.3 (MEDIUM) (AV:N/AC:L/Au:N/C:C/I:C/A:C)")
        print("|    A flaw in the Axis Camera Station Server that could lead to an authentication")
        print("|    bypass by default password settings or by brute forcing user:pass credentials")
        print("|")
        print("|  Disclosure date: 2025-07-11")
        print("|  Exploit results:")
        print("|    TITLE: can't retrieve web camera model/vendor from <title> tag")
        print("|    WEBCAM ACCESS: http://"..host.ip..":"..port.number..uri.." [LOGIN]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|")
        print("|  Referencies:")
        print("|    https://www.cisa.gov/news-events/ics-advisories/icsa-25-352-08")
        print("|    https://thehackernews.com/2025/08/6500-axis-servers-expose-remoting.html")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  Risk factor: Medium CVSSv2: 5.3 (MEDIUM) (AV:N/AC:L/Au:N/C:C/I:C/A:C)\n")
            file:write("|    A flaw in the Axis Camera Station Server that could lead to an authentication\n")
            file:write("|    bypass by default password settings or by brute forcing user:pass credentials\n")
            file:write("|\n")
            file:write("|  Disclosure date: 2025-07-11\n")
            file:write("|  Exploit results:\n")
            file:write("|    TITLE: can't retrieve web camera model/vendor from <title> tag\n")
            file:write("|    WEBCAM ACCESS: http://"..host.ip..":"..port.number..uri.." [LOGIN]\n")
            file:write("|      Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|\n")
            file:write("|  Referencies:\n")
            file:write("|    https://www.cisa.gov/news-events/ics-advisories/icsa-25-352-08\n")
            file:write("|    https://thehackernews.com/2025/08/6500-axis-servers-expose-remoting.html\n")
            file:write("|_\n")
            file:close()
        end
        return
    ...
    elseif ( check_uri.status == nil ) then
        ...
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: NIL [socket error]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: NIL [socket error]\n")
            file:write("|      Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
    ...
    elseif ( check_uri.status == 301 ) then
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [Moved Permanently]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [Moved Permanently]\n")
            file:write("|      Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
    ...
    elseif ( check_uri.status == 307 ) then
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [Temporary Redirect]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [Temporary Redirect]\n")
            file:write("|      Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
    ...
    elseif ( check_uri.status == 400 ) then
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [Bad Request]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [Bad Request]\n")
            file:write("|        Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
    ...
    elseif ( check_uri.status == 403 ) then
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [Forbidden]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [Forbidden]\n")
            file:write("|        Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
    ...
    elseif ( check_uri.status == 405 ) then
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [Method Not Allowed]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [Method Not Allowed]\n")
            file:write("|        Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
    ...
    elseif ( check_uri.status == 500 ) then
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [Internal Server Error]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [Internal Server Error]\n")
            file:write("|        Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
    ...
    elseif ( check_uri.status == 502 ) then
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [Bad Gateway]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [Bad Gateway]\n")
            file:write("|        Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
    ...
    elseif ( check_uri.status == 503 ) then
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [Service Unavailable]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [Service Unavailable]\n")
            file:write("|        Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
        ...
        print("|  STATUS: NONE AXIS WEBCAM FOUND")
        print("|  ID: CVE:CVE-2025-30026")
        print("|    REASON: http response code: "..check_uri.status.." [unknown]")
        print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
        print("|_\n")
        ...
        if ( logfile ~= "false" ) then
            ...
            file:write("|  STATUS: NONE AXIS WEBCAM FOUND\n")
            file:write("|  ID: CVE:CVE-2025-30026\n")
            file:write("|    REASON: http response code: "..check_uri.status.." [unknown]\n")
            file:write("|        Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
            file:write("|_\n")
            file:close()
        end
        ...
        for i, intable in pairs(tbl) do
            ...
            if ( validar ~= nil or title == intable ) then  --> uri found + version-vendor retrieved from <title>
                ...
                if ( logfile ~= "false" ) then
                    ...
                    file:write("|    WEBCAM ACCESS: http://"..host.ip..":"..port.number..uri.."\n")
                    file:write("|      Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
                    file:write("|\n")
                    file:write("|  Referencies:\n")
                    file:write("|    https://www.cisa.gov/news-events/ics-advisories/icsa-25-352-08\n")
                ...
                if (titletag == 68) then   --> uri found - but failed to match version-vendor from <title>
                    ...
                    print("|  Disclosure date: 2025-07-11")
                    print("|  Exploit results:")
                    print("|    TITLE: failed to retrieve webcam model/version from <title>")
                    print("|    URI ACCESS: http://"..host.ip..":"..port.number..uri)
                    print("|      Module Author: r00t-3xp10it & Cleiton Pinheiro")
                    print("|")
                    print("|  Referencies:")
                    ...
                    if ( logfile ~= "false" ) then
                        ...
                        file:write("|  Disclosure date: 2025-07-11\n")
                        file:write("|  Exploit results:\n")
                        file:write("|    TITLE: failed to retrieve webcam model/version from <title>\n")
                        file:write("|    URI ACCESS: http://"..host.ip..":"..port.number..uri.."\n")
                        file:write("|      Module Author: r00t-3xp10it & Cleiton Pinheiro\n")
                        file:write("|\n")
                        file:write("|  Referencies:\n")
